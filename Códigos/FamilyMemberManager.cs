...
public class FamilyMember
{
    ...
    public bool isAlive;
    public int age;
    public FamilyRole role; // ✅ NUEVO: Guardar el rol directamente
...
public class FamilyMemberManager : MonoBehaviour
{
    ...
    private Dictionary<string, GameObject> distanceTexts = new Dictionary<string, GameObject>();
...
public List<Location> predefinedLocations = new List<Location>
{
    ...
    private IEnumerator InitializeDistances()
    {
    ...
    public TMP_Dropdown familyRoleDropdown;
    
    private void InitializeFamilyRoleDropdown()
    {
            ...
            List<string> roleOptions = new List<string>
        {
            ...
            // Reiniciar el diccionario de roles
    ...
    public void SaveFamilyMember()
    {
        ...
        try
        {
            ...
            currentMember = new FamilyMember(
                ...
                birthDate,
                age,
                selectedRole, // ✅ Pasar el rol aquí
                isAlive
            );
    ...
    private void ConnectNewMember(FamilyMember newMember)
    {
    ...
    private void RecreateMapIcons()
    {
        ...
        // ✅ NO limpiar textos de distancia - se mantienen
    ...
    private GameObject CreateUILine(Vector2 startPos, Vector2 endPos, string name)
    {
        ...
        float extension = 230f; // Ajusta este valor según necesites
    ...
    private void CreateDistanceText(FamilyMember member1, FamilyMember member2, Vector2 position, float distance)
    {
        ...
        textComponentNew.fontSize = 24; // ✅ TAMAÑO DE FUENTE GRANDE (antes era 12)
        ...
        outline.effectDistance = new Vector2(2, 2); // ✅ Más grueso (antes era 1,1)
